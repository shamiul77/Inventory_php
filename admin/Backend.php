...
if(isset($_POST['saveCustomer'])){
    ...
    if($name != ''){
        ...
        if($emailCheck){
            if(mysqli_num_rows($emailCheck) > 0){
                redirect('customers.php', 'Email already used, Try another');
            }
        }
        $data = [
            'name'=> $name,
        ...
        redirect('customers.php', 'Please fill the required fields');
    }
}
...
if(isset($_POST['updateCustomer'])){
    ...
    if($name != ''){
        ...
        if($emailCheck){
            if(mysqli_num_rows($emailCheck) > 0){
                redirect('customerEdit.php?id='.$customerId, 'Email already used, Try another');
            }
        }
        $data = [
            'name'=> $name,
        ...
        if($result){
            redirect('customerEdit.php?id='.$customerId, 'Customer Updated Successfully!');
        }else{
            redirect('customerEdit.php?id='.$customerId, 'Something went wrong!');
        }
    }else{
        redirect('customerEdit.php?id='.$customerId, 'Please fill the required fields');
    }
}
